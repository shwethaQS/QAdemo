...
public abstract class BaseClass {
	...
	/*
	 * Executes before any testcase to launch application login to the
	 * application
	 */
	@BeforeClass
	...
	public static void closeApplication() throws InterruptedException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[contains(text(),'Logout')]"))).click();
		driver.quit();
